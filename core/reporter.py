...
class Reporter:
    def __init__(self, base_path):
        self.episodes = Context.config['episodes']
        self.work_dir = os.path.join(base_path, WORK_DIR)
        self.sw = Stopwatch()
        make_dir_if_not_exists(self.work_dir)
        self._history = []
    ...
    def _update_title(self, e, n, r, q):
        Context.window_title['episode'] = "|  %d/%d: N = %.2f, R = %+.0f, Q = %+.0f" % (e, self.episodes, n, r, q)
